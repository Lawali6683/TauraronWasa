// /pages/functions/api/football.js

// Wannan handler ɗin zaiyi aiki idan aka kira daga index.js
export async function handleFootball(request) {
  // A kira footballWorker domin yayi aikin da kake son sa
  return footballWorker(request);
}

// --- Babban Football Worker ---
async function footballWorker(request) {
