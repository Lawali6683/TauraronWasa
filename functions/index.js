// A cikin /pages/functions/index.js
import { handleGetLink } from "./api/getLink.js";
import { handleNewGame } from "./api/newgame.js";
import { handleFotbal } from "./api/footbal.js";
...
export async function onRequest(context) {
    ...
    if (request.method !== "POST" || !contentType.includes("application/json")) {
        const invalidResponse = new Response("Invalid Request Method or Content-Type", { status: 400 });
