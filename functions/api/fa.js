...
export async function onRequest(context) {
  ...
  try {
    ...
    if (!matchesResponse.ok) {
      ...
      console.error(`Error fetching FA Cup matches: ${matchesResponse.status} - ${errorText}`);
      const response = new Response(
        JSON.stringify({ error: true, message: `Failed to fetch FA Cup matches: ${matchesResponse.statusText}` }),
