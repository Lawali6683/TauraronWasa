export async function handleEropa(request) {
  return new Response("Eropa handler is working!", { status: 200 });
}
...
async function handleRequest(request) {
  ...
  try {
    ...
    const EUROPA_SCORERS_URL =
      "https://api.football-data.org/v4/competitions/EL/scorers?limit=10";

    // 🕒 Aika duka request ɗin lokaci guda
